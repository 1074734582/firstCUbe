...
int
crypto_sign_keypair(unsigned char *seeds, unsigned char *pk, unsigned char *sk)
{
	TEMPALLOC union {
...
// 	0x75c0b333,	0x1720e407,	0x834d4948,	0xa6e26e2b,
// 	0x9bff3bc9,
// 	0xb543e30e,
// 	0x5af8d150,
// 	0xd7e00d3d,
...
// 	0x00000000,
// };
// 	memcpy(nonce, falcon_sign_nonce, 40);
...
// 	0x00000000,
// };
// 	memcpy(seed, falcon_sign_seed, 48);
